...
//Verify Logo Text
Then(
  "the logo text should be displayed correctly",
  async function (this: CustomWorld) {
...
Then(
  "the user name should display {string}",
...
Then(
  "the user email should display {string}",
...
Then(
  "all uptime period colors should match their percentage thresholds",
  async function (this: CustomWorld) {
